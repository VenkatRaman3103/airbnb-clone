...
export default function PhotosUploader({ addedPhoto, onChange }) {
    ...
    function selectAsMainphoto(event, filename) {
        ...
        onChange([filename, ...addedPhoto.filter(
    ...
    return (
        <>
            <div className="flex gap-2">
                <input
                    type="text"
                    placeholder="Add link of the photos"
                    value={photoLink}
                    onChange={(event) => {
                    ...
                    addedPhoto.map((link) => (
                        <div className="h-32 flex relative" key={link}>
                            ...
                            <button
                                ...
                                className="absolute bottom-2 right-2 text-white bg-black bg-opacity-50 rounded-md py-1 px-2 cursor-pointer"
                            >
                                <svg
                            ...
                            <button
                                ...
                                className="absolute bottom-2 left-2 text-white bg-black bg-opacity-50 rounded-md py-1 px-2 cursor-pointer"
                            >
                                {link === addedPhoto[0] && (
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
